...
namespace CyberSoftDataCenter.Controllers
{
    public class NewsController : Controller
    {
        ...
        public NewsController(CdataCenterDbContext context)
        {
            _context = context;    
        }
        ...
        public async Task<IActionResult> Create([Bind("NewsId,Title,Auteur,DateNews,Message")] News news)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("NewsId,Title,Auteur,DateNews,Message")] News news)
        {
            if (id != news.NewsId)
            {
                return NotFound();
